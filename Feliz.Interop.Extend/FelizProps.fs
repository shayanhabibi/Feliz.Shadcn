...
type prop<'Property> =
    ...
    static member inline ariaControls ([<ParamArray>] ids: string []) = Interop.mkProperty<'Property> "aria-controls" (String.concat " " ids)
    ...
    static member inline ariaDescribedBy ([<ParamArray>] ids: string []) = Interop.mkProperty<'Property> "aria-describedby" (String.concat " " ids)
    ...
    static member inline ariaDropEffect ([<ParamArray>] values: AriaDropEffect []) = Interop.mkProperty<'Property> "aria-dropeffect" (values |> unbox<string []> |> String.concat " ")
    ...
    static member inline ariaFlowTo ([<ParamArray>] ids: string []) = Interop.mkProperty<'Property> "aria-flowto" (String.concat " " ids)
    ...
    static member inline ariaLabelledBy ([<ParamArray>] ids: string []) = Interop.mkProperty<'Property> "aria-labelledby" (String.concat " " ids)
    ...
    static member inline ariaOwns ([<ParamArray>] ids: string []) = Interop.mkProperty<'Property> "aria-owns" (String.concat " " ids)
    ...
    static member inline ariaRelevant ([<ParamArray>] values: AriaRelevant []) = Interop.mkProperty<'Property> "aria-relevant" (values |> unbox<string []> |> String.concat " ")
    ...
    static member inline key (value: Guid) = Interop.mkProperty<'Property> "key" (unbox<string> value)
    ...
    static member inline pattern (value: Text.RegularExpressions.Regex) = Interop.mkProperty<'Property> "pattern" value
    ...
    static member inline role ([<ParamArray>] roles: string []) = Interop.mkProperty<'Property> "role" (String.concat " " roles)
    ...
    /// Sets the value of a React controlled component.
    static member inline value (value: Guid) = Interop.mkProperty<'Property> "value" (unbox<string> value)
    /// Sets the value of a React controlled component.
    ...
    static member inline value (value: DateTime, includeTime: bool) =
        if includeTime
    ...
    /// The value of the element, interpreted as a date
    static member inline value (value: DateTime) = prop.value(value, includeTime=false)
    /// The value of the element, interpreted as a date, or empty if there is no value.
    static member inline value (value: DateTime option, includeTime: bool) =
        match value with
    ...
    /// `prop.ref` callback that sets the value of an input after DOM element is created.
    /// Can be used instead of `prop.defaultValue` and `prop.value` props to override input value.
    static member inline valueOrDefault (value: Guid) =
        prop.ref (fun e -> if e |> isNull |> not && !!e?value <> !!value then e?value <- !!value)
    /// `prop.ref` callback that sets the value of an input after DOM element is created.
    /// Can be used instead of `prop.defaultValue` and `prop.value` props to override input value.
...
module prop =
    ...
    type dur =
        ...
        static member inline clockValue (duration: TimeSpan) =
