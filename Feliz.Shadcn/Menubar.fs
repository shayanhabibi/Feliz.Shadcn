...
type [<Erase>] Shadcn =
    ...
    static member inline Menubar ( el : ReactElement ) = JSX.createElement Menubar [ menubar.asChild true ; props.children el ]
    ...
    static member inline MenubarMenu ( el : ReactElement ) = JSX.createElement MenubarMenu [ menubarMenu.asChild true ; props.children el ]
    ...
    static member inline MenubarTrigger ( el : ReactElement ) = JSX.createElement MenubarTrigger [ menubarTrigger.asChild true ; props.children el ]
    ...
    static member inline MenubarContent ( el : ReactElement ) = JSX.createElement MenubarContent [ menubarContent.asChild true ; props.children el ]
    ...
    static member inline MenubarItem ( el : ReactElement ) = JSX.createElement MenubarItem [ menubarItem.asChild true ; props.children el ]
    ...
    static member inline MenubarLabel ( el : ReactElement ) = JSX.createElement MenubarLabel [ menubarLabel.asChild true ; props.children el ]
    ...
    static member inline MenubarCheckboxItem ( el : ReactElement ) = JSX.createElement MenubarCheckboxItem [ menubarCheckboxItem.asChild true ; props.children el ]
    ...
    static member inline MenubarRadioGroup ( el : ReactElement ) = JSX.createElement MenubarRadioGroup [ menubarRadioGroup.asChild true ; props.children el ]
    ...
    static member inline MenubarRadioItem ( el : ReactElement ) = JSX.createElement MenubarRadioItem [ menubarRadioItem.asChild true ; props.children el ]
    ...
    static member inline MenubarSubContent ( el : ReactElement ) = JSX.createElement MenubarSubContent [ menubarSubContent.asChild true ; props.children el ]
    ...
    static member inline MenubarSubTrigger ( el : ReactElement ) = JSX.createElement MenubarSubTrigger [ menubarSubTrigger.asChild true ; props.children el ]
    ...
    static member inline MenubarGroup ( el : ReactElement ) = JSX.createElement MenubarGroup [ menubarGroup.asChild true ; props.children el ]
