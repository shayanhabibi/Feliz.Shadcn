...
[<JSX.Component>]
let Calendar : JSX.ElementType = JSX.jsx """
({
  className,
  classNames,
...
type [<Erase>] Shadcn =
    static member inline Calendar ( props : ICalendarProp list ) = JSX.createElement Calendar props
    static member inline Calendar ( children : ReactElement list ) = JSX.createElementWithChildren Calendar children
