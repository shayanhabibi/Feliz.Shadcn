...
type [<Erase>] Shadcn =
    ...
    static member inline DropdownMenuTrigger ( el : ReactElement ) = JSX.createElement DropdownMenuTrigger [ dropdownMenuTrigger.asChild true ; props.children el ]
    ...
    static member inline DropdownMenuContent ( el : ReactElement ) = JSX.createElement DropdownMenuContent [ dropdownMenuContent.asChild true ; props.children el ]
    ...
    static member inline DropdownMenuItem ( el : ReactElement ) = JSX.createElement DropdownMenuItem [ dropdownMenuItem.asChild true ; props.children el ]
    ...
    static member inline DropdownMenuCheckboxItem ( el : ReactElement ) = JSX.createElement DropdownMenuCheckboxItem [ dropdownMenuCheckboxItem.asChild true ; props.children el ]
    ...
    static member inline DropdownMenuRadioItem ( el : ReactElement ) = JSX.createElement DropdownMenuRadioItem [ dropdownMenuRadioItem.asChild true ; props.children el ]
    ...
    static member inline DropdownMenuLabel ( el : ReactElement ) = JSX.createElement DropdownMenuLabel [ dropdownMenuLabel.asChild true ; props.children el ]
    ...
    static member inline DropdownMenuGroup ( el : ReactElement ) = JSX.createElement DropdownMenuGroup [ dropdownMenuGroup.asChild true ; props.children el ]
    ...
    static member inline DropdownMenuSubContent ( el : ReactElement ) = JSX.createElement DropdownMenuSubContent [ dropdownMenuSubContent.asChild true ; props.children el ]
    ...
    static member inline DropdownMenuSubTrigger ( el : ReactElement ) = JSX.createElement DropdownMenuSubTrigger [ dropdownMenuSubTrigger.asChild true ; props.children el ]
    ...
    static member inline DropdownMenuRadioGroup ( el : ReactElement ) = JSX.createElement DropdownMenuRadioGroup [ dropdownMenuRadioGroup.asChild true ; props.children el ]
