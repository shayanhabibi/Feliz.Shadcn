[<AutoOpen>]
module Feliz.Shadcn.Jakobhoeg.Button
...
type [<Erase>] button =
    ...
    static member inline Icon ( value : ReactElement ) : IButtonProp = Interop.mkProperty "Icon" value

[<RequireQualifiedAccess>]
module [<Erase>] button =
    type [<Erase>] iconPlacement =
        static member inline left : IButtonProp = Interop.mkProperty "iconPlacement" "left"
        static member inline right : IButtonProp = Interop.mkProperty "iconPlacement" "right"
    type [<Erase>] variant =
        ...
        static member inline expandIcon : IButtonProp = Interop.mkProperty "variant" "expandIcon"
        static member inline ringHover : IButtonProp = Interop.mkProperty "variant" "ringHover"
        static member inline shine : IButtonProp = Interop.mkProperty "variant" "shine"
        static member inline gooeyRight : IButtonProp = Interop.mkProperty "variant" "gooeyRight"
        static member inline gooeyLeft : IButtonProp = Interop.mkProperty "variant" "gooeyLeft"
        static member inline linkHover1 : IButtonProp = Interop.mkProperty "variant" "linkHover1"
        static member inline linkHover2 : IButtonProp = Interop.mkProperty "variant" "linkHover2"
    type [<Erase>] size =
...
type [<Erase>] Shadcn =
    ...
    static member inline Button ( child : ReactElement ) = JSX.createElement Button [ button.asChild true ; button.children child ]
